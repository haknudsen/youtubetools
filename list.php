    ...
    try {
        ...
        foreach ( $channelsResponse[ 'items' ] as $channel ) {
            ...
            foreach ( $playlistItemsResponse[ 'items' ] as $playlistItem ) {
                $htmlBody .= sprintf( '<li>%s%s</li>', "https://www.youtube.com/watch?v=", $playlistItem[ 'snippet' ][ 'resourceId' ][ 'videoId' ] );
                $total++;
            }
            $htmlBody .= '</ul>';
            $htmlBody .= '<br>';
    ...
    <div class="container"> 
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="channel-list.php">Channel List<span class="sr-only">(current)</span></a> </li>
          <li class="divider"></li>
