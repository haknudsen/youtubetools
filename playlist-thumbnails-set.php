...
<head>
	<meta charset="utf-8">
	<title>Set Thumbnail for a Playlist</title>
 ...
 */
$OAUTH2_CLIENT_ID = '90875073625-c3k22oeo15lc8p086cf2307pmoatehp1.apps.googleusercontent.com';
$OAUTH2_CLIENT_SECRET = 'JA-Y1xPB89kEkpF2hHHB_ABl';
...
if ( $client->getAccessToken() ) {
	...
	try {
		...
		$imagePath = "E:\Dropbox\7.VideoSEO\1. To Start\TalkingHeads\Whiteboard\images/Whiteboard Animation Crowd.jpg";
  ...
  <p>You need to set <code>\$OAUTH2_CLIENT_ID</code> and
    <code>\$OAUTH2_CLIENT_ID</code> before proceeding.<p>";
} else {
