...
<body>
                ...
                <div class="row  text-capitalize center">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-sm-offset-2">
                            <button type="button" class="btn btn-drkblue" id="embed-left">Responsive</button>
                        </div>
                        <div class="col-sm-4">
    ...
    <section class="container">
        <div class="row">
        <div class="col-md-6">
            <div style="position: relative; padding-bottom: 56.25%;  height: 0; overflow: hidden;"><iframe type="text/html" style="position: absolute; top:0; left: 0; width: 100%; height: 100%" src="https://www.youtube.com/embed/n6yoYO6vB1g?autoplay=1&loop=1&rel=0" frameborder="0"></iframe></div>
            </div>
        </div>
