 ...
 * 2. Appending new tags to the video resource's Status.tags[] list
...
if ( $client->getAccessToken() ) {
    ...
    try {
        ...
        if ( empty( $listResponse ) ) {
            ...
            $htmlBody = '<form method="post" action="index.html">';
            $htmlBody .= '<input type="hidden" name="videoID" ';
            $htmlBody .= 'value="' . $videoId . '">';
            $htmlBody .= '<div>';
            $htmlBody .= '<h1 class="text-center">Privacy</h1>';
            $htmlBody .= '<h2 class="text-center">' . $videoId .'</h2>';
            $htmlBody .= '<h2 class="text-center" id="status">';
            $htmlBody .= $privacyStatus;
            $htmlBody .= '</h2>';
            $htmlBody .= '</div>';
            $htmlBody .= '<div class="row">';
            $htmlBody .= '<select name="privacyStatus" id="privacyStatus">
    ...
    <option value="private">Private</option>
            ...
            $htmlBody .= '</div>';
            $htmlBody .= '<div class="row">';
            $htmlBody .= '<input class="center-block" type="submit" value="Submit" id="submit" style="margin:10px auto"/>';
            $htmlBody .= '</div>';
            $htmlBody .= '</form>';
        }
...
<li><a href="thumbnails.php">Thumbnails</a> </li>
    ...
    <script>
        $('#privacyStatus').ready(function(){
        $('#privacyStatus').val($('#status').text());
